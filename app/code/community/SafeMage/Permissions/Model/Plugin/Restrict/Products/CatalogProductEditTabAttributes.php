...
class SafeMage_Permissions_Model_Plugin_Restrict_Products_CatalogProductEditTabAttributes
    extends SafeMage_Permissions_Model_Plugin_Restrict_Products_Block
{
    /**
     * Prepare readonly elements
     *
     * @param Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Attributes $object
     * @param null
    ...
    {
        $res = $this->getProductsClassHelper()->isCatalogProductEditTabAttributes($object);
        return $res;
    }
}
