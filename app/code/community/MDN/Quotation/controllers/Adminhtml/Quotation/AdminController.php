...
class MDN_Quotation_Adminhtml_Quotation_AdminController extends Mage_Adminhtml_Controller_Action {
    ...
    public function printAction() {
        try {
            ...
            if (!$error) {
                ...
                $this->_redirect('adminhtml/Quotation_Admin/edit', array('quote_id' => $quoteId));
        } catch (Exception $ex) {
    ...
    public function postAction() {
        ...
        if($data['status'] == 'active'){
            //Notify customer
            $quote->NotifyCustomer('true');
        }
        //confirm & redirect
        Mage::getSingleton('adminhtml/session')->addSuccess($this->__('quotation successfully saved.'));
        $this->_redirect('adminhtml/Quotation_Admin/edit', array('quote_id' => $quoteId, 'tab' => $this->getRequest()->getParam('tab_to_display')));
    }
    ...
    public function createAction() {
        ...
        $this->_redirect('adminhtml/Quotation_Admin/edit', array('quote_id' => $quote->getId()));
    }
    ...
    public function deleteAction() {
        ...
        $this->_redirect('adminhtml/Quotation_Admin/List');
    }
    ...
    public function ApplyDuplicateAction() {
        ...
        $this->_redirect('adminhtml/Quotation_Admin/edit', array('quote_id' => $newQuotation->getId()));
    }
    ...
    {
        $this->_redirect('adminhtml/system_config/edit', array('section' => 'quotation'));
    }
