...
class MDN_Quotation_Block_Adminhtml_SelectCustomer extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function getGridUrl() {
        ...
        return $this->getUrl('adminhtml/Quotation_Admin/customerSelectionGrid', $params);
    }
    ...
    public function getRowUrl($row) {
        ...
        switch ($this->_mode) {
            ...
            case 'new':
                $retour = $this->getUrl('adminhtml/Quotation_Admin/new', array('customer_id' => $row->getId()));
                break;
            case 'duplicate':
                $retour = $this->getUrl('adminhtml/Quotation_Admin/ApplyDuplicate', array('customer_id' => $row->getId(), 'quotation_id' => $this->getQuote()->getId()));
                break;
            default:
                $retour = $retour = $this->getUrl('adminhtml/Quotation_Admin/new', array('customer_id' => $row->getId()));
                break;
        }
