...
class MDN_Quotation_Block_Adminhtml_Edit_Tabs_General extends Mage_Adminhtml_Block_Widget_Form {
    ...
    public function getStoreMenu() {
        ...
        $html = '<select name="myform[store_id]">';
        ...
        foreach ($websites as $websiteId => $website) {
            ...
            foreach($website->getGroups() as $group)
            {
                ...
                {
                    $selected = ($this->getQuote()->getStoreId() == $store->getId() ? ' selected ' : '');
                    $html .= '<option value="'.$store->getId().'" '.$selected.'>&nbsp;&nbsp;&nbsp;&nbsp;'.$store->getName().'</option>';
                }
                $html .= '</optgroup>';
            }
        }
    ...
    public function getDeleteUrl() {
        return $this->getUrl('adminhtml/Quotation_Admin/delete', array('quote_id' => $this->getQuote()->getId()));
    }
    ...
    public function getViewAttachmentUrl() {
        return $this->getUrl('adminhtml/Quotation_Admin/DownloadAdditionalPdf/', array('quote_id' => $this->getQuote()->getquotation_id()));
    }
    ...
    public function getPrintUrl() {
        return $this->getUrl('adminhtml/Quotation_Admin/print', array('quote_id' => $this->getQuote()->getId()));
    }
    ...
    public function getNotifyUrl() {
        return $this->getUrl('adminhtml/Quotation_Admin/notify', array('quote_id' => $this->getQuote()->getId()));
    }
    ...
    public function getRemindUrl() {
        return $this->getUrl('adminhtml/Quotation_Admin/RemindCustomer', array('quote_id' => $this->getQuote()->getId()));
    }
