...
abstract class MDN_Quotation_Model_Pdfhelper extends Mage_Sales_Model_Order_Pdf_Abstract {
    ...
    public function AddAddressesBlock($page, $LeftAddress, $RightAddress, $TxtDate, $TxtInfo) {
        $page->drawLine($this->_PAGE_WIDTH / 2 - 50, $this->y + 10, $this->_PAGE_WIDTH / 2 - 50, $this->y - 160);
        ...
        $this->y -= 10;
        $page->drawLine(10, 420, $this->_BLOC_ENTETE_LARGEUR, $this->y);

        $this->y -= 20;
        $LeftAddress = $this->WrapTextToWidth($page, $LeftAddress, $this->_PAGE_WIDTH / 2 - 150);
        $RightAddress = $this->WrapTextToWidth($page, $RightAddress, $this->_PAGE_WIDTH / 2 - 150);
