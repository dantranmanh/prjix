 ...
 */
class Amasty_Customerattr_Block_Adminhtml_Customer_Attribute_Edit_Tab_Options
    extends Mage_Adminhtml_Block_Widget
{
    ...
    public function getOptionValues()
    {
        ...
        if ($attributeType == 'select' || $attributeType == 'multiselect'
            || $attributeType == 'selectimg'
            || $attributeType == 'multiselectimg'
        ) {
            ...
            if ('selectgroup' != $this->getAttributeObject()->getTypeInternal()
                ...
                foreach ($optionCollection as $option) {
                    $value = $this->_getValues(
                        $option, $defaultValues, $inputType
                    );
    ...
    protected function _getValues($option, $defaultValues, $inputType)
    {
        ...
        foreach ($this->getStores() as $store) {
            ...
            if (isset($storeValues[$option->getId()])) {
                $value['store' . $store->getId()] = htmlspecialchars(
