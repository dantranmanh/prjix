 ...
 */
class Amasty_Customerattr_Block_Rewrite_Sales_Order_View_Info
                ...
                if ($inputType == 'select' || $inputType == 'selectimg'
                    ...
                    if ($currentData) {
                        $downloadUrl = Mage::helper('amcustomerattr')
                            ->getAttributeFileUrl($currentData, true);
                        $fileName = Mage::helper('amcustomerattr')
                            ->cleanFileName($currentData);
                        $value = '<a href="' . $downloadUrl . '">'
                            . $fileName[3] . '</a>';
                    } else {
