...
class Amasty_Customerattr_Model_Rewrite_Catalog_Product_Flat_Indexer
    extends Mage_Catalog_Model_Product_Flat_Indexer
{
    function updateAttribute($attributeCode, $store = null, $productIds = null)
    {
        ...
        if ($attribute
            && $attribute->getData('entity_type_id') == Mage::getModel(
                'eav/entity'
