 ...
 * @package Amasty_Meta
 */
class Amasty_Meta_Adminhtml_Ammeta_ConfigController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('cms/amseotoolkit/ammeta/meta_category');
    }
}