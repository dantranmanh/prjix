...
$this->run(
    "CREATE TABLE IF NOT EXISTS `{$this->getTable('ampgrid/grid_column')}`(
...
$this->run(
    "CREATE TABLE IF NOT EXISTS `{$this->getTable('ampgrid/grid_group_column')}`(
...
$this->run(
    "CREATE TABLE IF NOT EXISTS `{$this->getTable('ampgrid/grid_group_attribute')}`(
