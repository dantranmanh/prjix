...
class Hxtech_logistic_Block_Rewrite_Adminhtml_Customer_Edit_Tab_Addresses extends Mage_Adminhtml_Block_Customer_Edit_Tab_Addresses
{
	public function initForm()
    {
        ...
        $closestPortElement = $form->getElement('closestport_name');
	    if ($closestPortElement) {
	      	$closestPortElement->setRenderer(Mage::getModel('logistic/customer_renderer_closestport'));
	    }
