...
class Hxtech_Logistic_Block_Adminhtml_Logistic_Edit_Renderer_Tier
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    {
        $this->setTemplate('logistic/tier.phtml');
    }
    ...
    public function getValues()
    {
        ...
        $data = Mage::getModel('logistic/tiercommission')->getCollection()->addFieldToFilter('logistic_user_id', $logisticId)->getData();
