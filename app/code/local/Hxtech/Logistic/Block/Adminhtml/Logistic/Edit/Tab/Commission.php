...
class Hxtech_Logistic_Block_Adminhtml_Logistic_Edit_Tab_Commission extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $tierCommissionField->setRenderer(
            $this->getLayout()->createBlock('logistic/adminhtml_logistic_edit_renderer_tier')
        );
