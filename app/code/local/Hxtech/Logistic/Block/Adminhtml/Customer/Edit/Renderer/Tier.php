...
class Hxtech_Logistic_Block_Adminhtml_Customer_Edit_Renderer_Tier
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    {
        $this->setTemplate('logistic/tierimporter.phtml');
    }
    ...
    {
        $values = array();
        $importerId = Mage::app()->getRequest()->getParam('id');
        $data = Mage::getModel('logistic/importertier')->getCollection()->addFieldToFilter('importer_user_id', $importerId)->getData();
