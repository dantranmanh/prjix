...
abstract class Hxtech_Logistic_Model_Pdf_Abstract extends Mage_Sales_Model_Order_Pdf_Abstract {
     ...
     *
     */
    public function AddLogisticInfoBlock($page, $logistic) {
        $page->setFont(Zend_Pdf_Font::fontWithName(Zend_Pdf_Font::FONT_HELVETICA), 14);
        $this->y -= 20;

        $page->drawText($logistic->getUsername(), 25, $this->y, 'UTF-8');
        $this->y -= 15;
        $page->drawText($logistic->getEmail(), 25, $this->y, 'UTF-8');
        $this->y -= 15;
        $page->drawText($logistic->getStreet(), 25, $this->y, 'UTF-8');
        $this->y -= 15;
        $page->drawText($logistic->getWebsite(), 25, $this->y, 'UTF-8');
        $this->y -= 15;
