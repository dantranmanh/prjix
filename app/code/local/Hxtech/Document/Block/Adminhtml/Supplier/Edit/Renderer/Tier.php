...
class Hxtech_Document_Block_Adminhtml_Supplier_Edit_Renderer_Tier
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    {
        $this->setTemplate('document/tier.phtml');
    }
     ...
     *
     * @return Hxtech_Logistic_Block_Adminhtml_Logistic_Edit_Renderer_Tier
     */
    protected function _prepareLayout()
    {
        $button = $this->getLayout()->createBlock('adminhtml/widget_button')
            ->setData(array(
                'label' => Mage::helper('document')->__('Add Tier'),
    ...
    public function getValues()
    {
        ...
        $documentSupplierId = Mage::app()->getRequest()->getParam('id');
        $data = Mage::getModel('document/tiercommission')->getCollection()->addFieldToFilter('document_user_id', $documentSupplierId)->getData();
