...
class Magebuzz_Outstocknotification_Block_Outstocknotification extends Mage_Core_Block_Template {
  public function __construct() {
		...
		$a = Mage::getModel('productalert/stock')->getCollection();
		// zend_debug::dump($a->getData());die;
		$collection = Mage::getModel('productalert/stock')->getCollection()->addFieldToFilter('customer_id',$customer_id);
