...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Sales_Order_Address
    extends Mage_Adminhtml_Block_Sales_Order_Address
	{
	}
} else {  
	 
	class HTZ_Vendor_Block_Adminhtml_Sales_Order_Address extends Mage_Adminhtml_Block_Sales_Order_Address
	{
